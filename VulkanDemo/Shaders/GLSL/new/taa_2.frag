...
///////////////////////////////////////////////////////////////////////////////
	...
	float testVel = feedbackFactor - (length(velocity));
...
void main()
{
	...
	vec2 closestVec = -texture(velocitySampler, GetClosestUV(depthSampler)).rg;
	...
	for(uint iter = 0; iter < kNeighborsCount; iter++)
	{
		...
		previousDepths[iter] = texture(preDepthSampler, newUV + closestVec).x;
	}
